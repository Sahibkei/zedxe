...
export default function OrderBookPanel({ className }: OrderBookPanelProps) {
    return (
        <section
            className={cn(
                "min-h-0 rounded-xl border border-white/10 bg-[#0d1118] p-3 shadow-[0_14px_40px_rgba(0,0,0,0.35)]",
        ...
        >
            ...
            <div className="min-h-0 flex-1 overflow-hidden">
                <div className="h-full overflow-y-auto overflow-x-auto lg:overflow-x-hidden">
                    <div className="grid min-w-[800px] grid-cols-1 gap-2 sm:grid-cols-2 lg:min-w-0 lg:grid-cols-3">
