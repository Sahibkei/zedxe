...
import { LayoutDashboard, Newspaper, ArrowLeftToLine, FileBarChart2, ScrollText } from 'lucide-react';
...
const TERMINAL_ITEMS = [
    ...
    { href: '/terminal/research-wire', label: 'Research Wire', icon: ScrollText, code: 'RPT' },
